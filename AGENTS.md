...
This project is indexed by GitNexus as **lugo** (2405 symbols, 8183 relationships, 201 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
