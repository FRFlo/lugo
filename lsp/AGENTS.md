...
| `fivem_natives.go` | ~500 | Native function catalog (GTA5, RDR3, NY) |
...
- **Native Functions**: Version-aware native catalog (GTA5, RDR3, NY) generated by `scripts/fivem_native_catalog/main.go`
